...
import { 
  ...
  getStudentDashboard, getStudentQuizHistory 
} from '@/services/apiClient';
import type { User, AlertInsight, LearningProgress, QuizHistory } from '@/types/api';
import { Download, Calendar, Activity, AlertCircle, Bot, BookOpen, Clock, ChevronRight, Loader2, Search } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="bg-blue-600 text-white rounded-3xl p-8 shadow-md">
         ...
         <div className="flex gap-4">
            <button className="bg-white text-blue-700 px-6 py-2.5 font-bold rounded-lg shadow-sm text-sm hover:focus">View Recovery Plan</button>
            <button className="border border-blue-400 text-white px-6 py-2.5 font-bold rounded-lg hover:bg-blue-700 transition text-sm">Edit Plan</button>
         </div>
      </div>
    </>
  );
