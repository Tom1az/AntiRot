            ...
            <div>
               ...
               <div className="space-y-4 max-w-md">
                   <div>
                       ...
                       <input type="text" className="w-full rounded-xl px-4 py-3 text-sm bg-white shadow-[0_4px_20px_rgb(0,0,0,0.03)] outline-none focus:shadow-[0_4px_20px_rgb(0,0,0,0.08)] transition" defaultValue={user?.full_name || 'N/A'} />
                   </div>
                   <div>
                       <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5">Email Address</label>
                       <input type="email" className="w-full rounded-xl px-4 py-3 text-sm bg-white shadow-[0_4px_20px_rgb(0,0,0,0.03)] outline-none focus:shadow-[0_4px_20px_rgb(0,0,0,0.08)] transition" defaultValue={isTeacher ? 'teacher@antirot.ai' : 'student@antirot.ai'} />
                   </div>
                   <div>
