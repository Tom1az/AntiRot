...
import { LayoutDashboard, MessageSquareText, FileQuestion, LineChart, Settings } from 'lucide-react';
  ...
  return (
    <aside className="w-64 bg-slate-50 flex flex-col h-full sticky top-0 z-10 shadow-[4px_0_24px_rgba(0,0,0,0.04)]">
      <div className="px-8 py-8">
        <h1 className="font-bold text-2xl text-blue-700 tracking-tight">AntiRot<span className="text-blue-400">.</span></h1>
        <p className="text-[10px] text-slate-500 font-bold mt-1 tracking-widest uppercase">Digital Curator</p>
      </div>
